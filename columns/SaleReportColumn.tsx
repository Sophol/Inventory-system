...
export const SaleReportColumn: ColumnDef<Sale>[] = [
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title="Customer"
        className="text-center whitespace-nowrap text-[9px] "
      />
    ),
    cell: ({ row }) => (
      <div className="text-center whitespace-nowrap text-[9px] ">
        {row.original.customer?.title ?? "N/A"}
      </div>
    ),
  },
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <span className="flex justify-end  whitespace-nowrap text-right px-4">
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title="Discount"
        className="flex whitespace-nowrap justify-center px-4"
      />
    ),
    cell: ({ row }) => {
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title="Delivery"
        className="flex justify-center whitespace-nowrap px-4"
      />
    ),
    cell: ({ row }) => {
